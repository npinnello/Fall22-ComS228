...
public class MsgTree {
  ...
  */
    ...
    */
     ...
     * performs  recursive  preorder  traversal  of  the  MsgTree  and  prints 
all the characters and their bit codes
    ...
    /**
     * extra credit statistics. Gets the decoded strings and prints the data values for each statistic.
     * @param encryptedText
     */
   ...
   /**
    * Scans in the user input and decodes the selected file. 
    * If the file does not exist, catches an exception.
    * Uses MsgTree to call printCodes,decode, and printStatistics using the encryptedText values.
    * @param args
    */
